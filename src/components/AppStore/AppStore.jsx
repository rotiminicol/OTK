      ...
      <div className="py-14" style={backgroundStyle}>
        <div className="container">
          <div className="grid sm:grid-cols-2 grid-cols-1 items-center gap-4">
            ...
            >
              {/* Text Section */}
              <h1 className="text-2xl text-center sm:text-left sm:text-4xl font-semibold text-blue-500 pl-3">
                Download Top Betting Apps Today
              </h1>
              <p className="text-blue-300 text-sm sm:text-base text-center sm:text-left">
